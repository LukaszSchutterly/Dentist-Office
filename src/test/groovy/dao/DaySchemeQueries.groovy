...
class DaySchemeQueries extends Specification {
    ...
    def "should return past day schemes"() {
        ...
        DayScheme daySchemeOne = DaySchemeStaticFactory.createDefaultDayScheme(someOldDateOne)
        when:
    ...
    def "should return latest day scheme"(){
        ...
        DayScheme dayScheme = DaySchemeStaticFactory.createDefaultDayScheme(futureDate)
        when:
